<template>
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg">
        <DutyList title="Freebird (Heavensward)" :duties="db.hwFreebird" />
        <DutyList title="Freebird (Stormblood)" :duties="db.sbFreebird" />
      </div>
      <div class="col-lg">
        <DutyList title="Freebird (Shadowbringers)" :duties="db.shbFreebird" />
        <DutyList title="Freebird (Endwalker)" :duties="db.ewFreebird" />
      </div>
    </div>
    <div class="row">
      <h2>Blue Mage</h2>
